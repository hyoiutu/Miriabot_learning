...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  from_train_path = "./my_data_dir/source.dat"
  to_train_path = "./my_data_dir/target.dat"
  from_dev_path = "./my_data_dir/sourceTest.dat"
  to_dev_path = "./my_data_dir/targetTest.dat"
